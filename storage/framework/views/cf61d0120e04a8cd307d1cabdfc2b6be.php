  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="<?php echo e(route('homepage')); ?>">Start Bootstrap</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo e(route('homepage')); ?>">Home</a>
            </li>
            <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\KUIS\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>